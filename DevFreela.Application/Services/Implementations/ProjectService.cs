...
namespace DevFreela.Application.Services.Implementations
{
    public class ProjectService : IProjectService
    {
        ...
        public ProjectDetailsViewModel GetById(int id)
        {
            ...
            var projectDetailsViewModel = new ProjectDetailsViewModel(project.Id, project.Tittle, project.Description,project.TotalCost, project.StartedAt, project.FinishAt);
